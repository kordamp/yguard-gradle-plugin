...
class LineNumberTable {
    final Property<String> mappingScheme
    final Property<String> scramblingSalt
    final ListProperty<String> includes
    final ListProperty<String> excludes

    @Inject
    LineNumberTable(Project project) {
        mappingScheme = project.objects.property(String)
        scramblingSalt = project.objects.property(String)
    ...
    boolean isEmpty() {
        !mappingScheme.present &&
            !scramblingSalt.present &&
            !hasPatternSet()
    }
}